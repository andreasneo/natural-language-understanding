...
def main(args):
    ...
    for epoch in range(last_epoch + 1, args.max_epoch):
        ...
        for i, sample in enumerate(progress_bar):
            ...
            Calculate the loss based on the output.
            Backward() calculates the derivative of the loss for every parameter x, dloss/dx.
            Normalizes the gradients preventing large updates on the model.
            Resetting the gradients to 0, preventing mixing the gradients between the mini-batches.
